...
- test スイート: **measured** — `kbb -M:test` 実測:
...
再現コマンド: `cd /Users/junkawasaki/github/com-junkawasaki/orgs/kotoba-lang/robotics && kbb -M:test`、`cd /Users/junkawasaki/github/com-junkawasaki/orgs/kotoba-lang/giemon && kbb -M:test` ( 両者 exit 0)。seeded 再現は L0 で N/A。