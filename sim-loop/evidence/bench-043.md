...
# seeded 再現 (軽量):
cd /Users/junkawasaki/github/com-junkawasaki/orgs/kotoba-lang/giemon && kbb -M -i /tmp/seed_parity_bench043.clj
...
kbb -M -e "$(cat /tmp/b43_h16b.clj)" > /tmp/b43_h16b_r1.txt 2>&1
kbb -M -e "$(cat /tmp/b43_h16b.clj)" > /tmp/b43_h16b_r2.txt 2>&1
