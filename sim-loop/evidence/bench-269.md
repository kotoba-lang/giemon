...
## judgement: measured — silent-zero 継続 25 連続 (runner 未修復)

## load
- 7:05 up 10 days, 23:48, load averages: 11.62 (15min) / ncpu=10 → ~1.16x、2x gate 未満で test 実行実施。
...
- 両 suite とも silent-zero (0/0/0 RC=0)。bench-244〜268 から **25 連続**の既知状態。
