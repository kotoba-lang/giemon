...
## judgement
- clojure -M:test (robotics / giemon): **unmeasured — skipped (load)**。負荷帯が閾値を大きく超過するため実行を省略。基准値据え置き ( robotics 14/50/0、giemon 46/115/0 )。回帰は assert しない ( honest unmeasured )。
