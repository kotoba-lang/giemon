...
- robotics `clojure -M:test`: 14 tests / 50 assertions / 0 failures, 0 errors, RC=0 (基準値一致)
- giemon `clojure -M:test`: 46 tests / 115 assertions / 0 failures, 0 errors, RC=0 (基準値一致)
