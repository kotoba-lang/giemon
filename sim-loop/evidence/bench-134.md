# bench-134 — unmeasured (HOST LOAD gate 超過で skip)

状態: HOST LOAD 15min ≈ 25.17 ( 06:34 実測: 1min 43.31、5min 32.00、15min 25.17) が ncpu=10 に対し ≈ 2.5×( Load gate ( 15min ≥  󰁣×ncpu = 20) を超過 — 前回 bench-133 の skip 帯 ( 15min ≈24.61-24.70) と同水準・むしろ上回る高負荷帯。重い test スイート実行は応答不能リスク高のため省略 ( honest 据え置き)。

- uptime (06:34):: 1min 43.31、5min 32.00、15min ≈ 25.17 — いずれも gate ( 15min ≥ 20) 超過。実行不可と判断。
