...
- date-run: 2026-09-14 01:05 JST (決定的・タイムスタンプは記録のみ)
- host load: `up 8 days, 17:48, load averages: 11.47 12.23 11.24`, hw.ncpu=10
  → 15-min ≈ 1.2x < 2x gate, therefore ran (not skipped).
