...
| profile | description |
|---|---|
| `giemon-sim` | giemon シミュレーション学習成熟ループ: giemon-sim (15-30min cron cowork) |
| `giemon-sim-bench` | giemon シミュレーション学習成熟ループ: bench (15-30min cron cowork) |
| `giemon-sim-falsify` | giemon シミュレーション学習成熟ループ: falsify (15-30min cron cowork) |
| `giemon-sim-rank` | giemon シミュレーション学習成熟ループ: rank (15-30min cron cowork) |
